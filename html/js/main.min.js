...
(a+=",.u_menu_sel"),k(a),w.filter(a))}function ka(){k("fetchData");var a;v?(a=jb+"?",Ia.length&&(a+="&"+Ia),x()&&(a+="&fiche"),(la||I)&&-1==a.indexOf("since=")?a+="since="+ma:0<na&&!I&&(a+="&pre_fetch_mins="+na),I&&-1==a.indexOf("now=")&&(a+="&now="+Utils.getSQLTimeStamp(A()))):a=HISTORICAL_DATA_PATH;$.ajax({dataType:"json",url:a,success:kb,error:lb})}function oa(a){y||(k("START",1==a),requestAnimationFrame(Ja),y=!0,!0!==a&&t.setValue("Playing",y))}function pa(a){y&&(k("STOP",1==a),y=!1,!0!==a&&t.setValue("Playing",
y))}function Ja(a){Y.begin();if(y){Ka();var d=m.length,g=0,b=0,c=0;for(a=Z+1;a<d;a++){var f=m[a];if(f.date.getTime()<=e.playback_date.getTime())if(O())k("Not adding new view as animating");else{k("Viewed",a,Utils.shortDateString(f.date),Utils.shortDateString(e.playback_date),f.date.getTime(),e.playback_date.getTime());if(!v){var h=f,l=e.canvas.getContext("2d");l.strokeStyle="#00ff00";l.lineWidth=1;l.globalAlpha=1;var mb=e.canvas.height/2-3,p=e.canvas.height/2+3;l.beginPath();var n=(h.date-e.start_date)/
1E3/e.duration_secs*e.canvas.width;h.isPublished()?(l.moveTo(n,p),l.lineTo(n,e.canvas.height)):(l.moveTo(n,0),l.lineTo(n,mb));l.stroke();l.globalAlpha=1}La(f);f.hasImage()?c++:b++;Z=a;g++}else break}0<b&&0==c&&(0<P.length&&Ma(),F());if(0<G&&0==Q&&(d=aa.length,g=[],d>G)){k("over visible limit, about to remove",d-G);for(a=0;a<d-G;a++)b=aa.shift(),k(" About to remove:",b),g.push(b),$("div[data-id="+b+"]").remove();F()}X&&(a=A(),d='<span class="tcolon" style="visibility:'+(0==a.getSeconds()%2?"hidden":
"visible")+';">$</span>',d=Ga(a,!0,nb,d),a=a.getDate()+" "+Utils.getLongMonthName(a)+" "+a.getFullYear()+", ",$(".u_menu_sel .time_stamp").html(d),$(".u_menu_sel .date").html(a));K&&qa()}Y.end();requestAnimationFrame(Ja)}function Ka(){if(v)e.playback_date.setTime(A().getTime()-6E4),e.end_date.setTime(e.playback_date.getTime()),e.position=1;else{e.playback_date.setTime(e.playback_date.getTime()+1E3*e.playback_seconds_step);e.position=(e.playback_date.getTime()-e.start_date.getTime())/1E3/e.duration_secs;
...
0<Va&&Qa(Va),Ta(S));if(pb)for(k("ADDING ALL!"),c=0;c<d;c++)La(m[c]);else la||y||(oa(),x()&&(sa=!1));la=!0}else console.error("Json missing 'views'");v&&sa&&setTimeout(ka,I?ta/Fa:ta)}function lb(a,d,b){console.error("dataLoadError",d,b);v&&sa&&setTimeout(ka,ta)}function qb(a){var d=Math.random();null!=a?a.isPublished()?d=a.hasRegularImage()?Math.min(.25,d):a.hasImage()?Math.min(.25,d):0:a.hasRegularImage()&&(d=Math.min(1,d+.5)):d=1;return(1+2*d)*ua}function La(a){var d=qb(a),b=a.index,e=a.getDivID(),
...
g.isPublished());g.hasImage()?(c=g.getBestImgUrl(ub?"":"img_l"),h.load(function(){k("image loaded",$(this).attr("src"));$("#u_overlay > #loading_spinner").hide();Utils.show($(this));ya();Ya(f);Utils.show("#details-card")}),$("#u_overlay > #loading_spinner").show(330),h.attr("src")!=c?h.attr("src",c):setTimeout(function(){h.load()},100),Utils.hide($("#details-card > #details-no-image"))):(Utils.hide(h.attr("src","")),$("#details-card > #details-no-image > #details-big-text").text(g.title),Utils.show($("#details-card > #details-no-image")));
...
for(var b=!1,c=0;c<a.length;c++)if(a[c].clientWidth<a[c].scrollWidth||a[c].clientHeight<a[c].scrollHeight){b=!0;break}b&&k("Truncated Text @ details-label p["+c+"]")}function xb(a){setTimeout(function(){cb(!0)},250)}function yb(a){cb()}function cb(a){!0===a&&F();k("resize",window.innerWidth,window.innerHeight,window.scrollY);S&&ra();U&&ya();a=t._panel.style.top.split("px")[0];t.setPosition(window.innerWidth-170,a);x()&&Pa()}function zb(a){var b=t._panel.style.left.split("px")[0];t.setPosition(b,window.scrollY+
45);O()||(U&&N(a.shiftKey?10:1),V&&B(a.shiftKey?10:1))}function Ab(a){var b=a.clientY;ba.x=a.clientX;ba.y=b;x()&&Pa()}function Bb(a){switch(a.keyCode){case 27:O()||(U&&N(a.shiftKey?10:1),V&&B(a.shiftKey?10:1));break;case 76:a.altKey&&(da=!da,$(".card_text_label, #details-labels").css({visibility:da?"visible":"hidden"}));break;case 83:a.altKey&&(K=!K,Sa(K));break;case 85:a.altKey&&(t.toggleVisibility(),Aa=!Aa);break;case 84:a.altKey&&(S=!S,Ta(S));break;case 68:a.altKey&&a.shiftKey&&(T=!T,$(".card_text_label").show(),
$(".card_text_label > .debug_label").toggle(T));break;case 80:y?(pa(),K&&qa()):oa()}}var h=Utils.getURLParameter,Ba=h("remote",!1),Cb=(Ba?"http://unstacked.dxlab.sl.nsw.gov.au/":"")+"cache/imgs/covers/",Db=(Ba?"http://unstacked.dxlab.sl.nsw.gov.au/":"")+"cache/",jb=(Ba?"http://unstacked.dxlab.sl.nsw.gov.au/":"")+"php/data/Durham.json?b=2",r={BOTH:{value:0,label:"Both"},UNPUB:{value:1,label:"Non-published"},PUB:{value:2,label:"Published"}},u={ALL:{value:0,label:"Show All"},WITH_IMAGE:{value:1,label:"With Images"},
WITHOUT_IMAGE:{value:2,label:"Without Images"}},Oa={INTERACTIVE:{value:0,label:"Interactive"},DISPLAY:{value:1,label:"Display"},FICHE:{value:2,label:"Fiche"}},m=[],Z=-1,H={unpub_count:0,unpub_w_image:0,pub_count:0,pub_covers:{thumb:0,regular:0}},v=h("live_mode",!0),ta=1E3*h("live_refresh_interval",60),na=h("live_start_offset_mins",0),fa=h("playback_speed",1/60),da=h("show_labels",!0),C=h("img_display_src",u.ALL.value),S=h("show_timeline",!0)&&!v,D=h("data_src",r.BOTH.value),Na=h("display_mode",Oa.INTERACTIVE.value),
pb=h("add_all",!1),ub=h("get_large_imgs",!1),G=h("visible_limit",64)*(Utils.isMobile.any()?.5:1);x()&&(G=0);var Eb=h("generated_secs",!0),Ua=h("hide_scroll",!1),Aa=h("dev_ui",!1),X=h("menu",!x()),xa=h("menu_on_top",!1),ib=h("auto_open_menu",!1),J=!1,Fb=h("show_home",!x()),za=h("auto_close_home",!0),I=h("abs_date_mode",!1),fb=h("abs_start_date","2016-03-22 08:59"),Fa=Math.abs(h("abs_date_speed",1)),$a,Da=h("show_instruction",!x()),ha=h("auto_close_instructions",!0),Ea,sa=h("auto_refresh",!0),Ia=h("extra_data_args",
"").split(",").join("&"),Xa=h("audiofx",!1)&&null!=window.Tone;if(Xa){var wa=(new Tone.PolySynth(6,Tone.Synth)).toMaster(),db={attack:.1,release:4,releaseCurve:"linear"},eb={baseFrequency:200,octaves:2,attack:0,decay:0,release:1E3};wa.set({voice0:{oscillator:{type:"sawtooth"},envelope:db,filterEnvelope:eb},voice1:{oscillator:{type:"sine"},envelope:db,filterEnvelope:eb},envelope:{attack:.33,decay:.2,release:.8,sustain:.5},volume:-12});var va=(new Tone.Panner(0)).toMaster();wa.connect(va)}var ca=h("outer_margin",
10),Ca=h("use_moment",!0),nb=h("clock_show_secs",!1),U=!1,V=!1,e={start_date:null,end_date:null,playback_date:null,playback_seconds_step:fa,position:0,canvas:null,position_canvas:null},ma,E=h("anim",x()?0:3),T=h("debug_labels",!1),Gb=h("debug",!0),gb=h("trace",!1),K=h("status",Gb),R=h("wall_margin",10),Va=h("start_offset",0),y=!1,w,ua=h("wall_seed_width",200),Y=new Stats;Y.setMode(0);c=b=null;var aa=[],t,ba={x:0,y:0},Q=0,ea=[],P=[],la=!1,Ra="",Wa={css:{transform:"scale(1)"},delay:.33};Ca&&moment.tz.add(["Australia/Sydney|AEST AEDT|-a0 -b0|0101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101|-293lX xcX 10jd0 yL0 1cN0 1cL0 1fB0 19X0 17c10 LA0 1C00 Oo0 1zc0 Oo0 1zc0 Oo0 1zc0 Rc0 1zc0 Oo0 1zc0 Oo0 1zc0 Oo0 1zc0 Oo0 1zc0 Oo0 1zc0 14o0 1o00 Oo0 1zc0 Oo0 1zc0 Oo0 1zc0 U00 1qM0 WM0 1tA0 WM0 1tA0 U00 1tA0 Oo0 1zc0 Oo0 1zc0 Oo0 1zc0 Rc0 1zc0 Oo0 1zc0 Oo0 1zc0 11A0 1o00 11A0 1o00 11A0 1o00 11A0 1qM0 WM0 11A0 1o00 1qM0 11A0 1o00 11A0 1o00 11A0 1qM0 WM0 1qM0 11A0 1o00 WM0 1qM0 14o0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1fA0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1fA0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1fA0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1fA0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1cM0 1fA0 1cM0 1cM0 1cM0 1cM0|40e5"]);
var l=function(a){this.use_moment=Ca;this.zone="Australia/Sydney";this.date=this.use_moment?null==a?moment.tz(this.zone):moment.tz(a,this.zone):null==a?new Date:new Date(a)};l.fromSQLStamp=function(a){return Ca?new l(a):new l(new Date(a.slice(0,4),a.slice(5,7)-1,a.slice(8,10),a.slice(11,13),a.slice(14,16),a.slice(17,19)))};l.prototype.getZoneAbbreviation=function(){return this.use_moment?moment.tz(this.zone).zoneAbbr():"BST"};l.prototype.toLocaleTimeString=function(){return this.use_moment?this.date.format("h:mm a"):
...
c.call_num.length&&-1!=c.call_num.indexOf(".")&&(c.dewey_index=n.getIndex(c.call_num)));a.hasOwnProperty("date")&&(c.date_stamp=a.date,c.date=l.fromSQLStamp(a.date),Eb&&(Math.seedrandom(c.getSeedString()),c.date.setSeconds(Math.floor(59*Math.random()))));return c};q.prototype.setVar=function(a,b,c){void 0==c&&(c=b);a.hasOwnProperty(b)&&(this[c]=a[b])};q.prototype.getLocationURL=function(){return this.published?"http://library.sl.nsw.gov.au/search~S2?/"+this.uri:"http://discover.durham.ac.uk/"+this.uri+
"&srchanddisc=1"};q.prototype.getImageURL=function(a){switch(a){case "img_t":case "img_r":case "img_l":return this.makeImageURL(a)}return""};q.prototype.getDivID=function(){return"card"+this.index};q.prototype.makeImageURL=function(a){return""==this[a]||void 0==this[a]?"":this.isPublished()?Cb+this[a]:Db+this[a]};q.prototype.isPublished=function(){return this.published};q.prototype.getDateString=function(){return this.date.getFullYear()+"/"+Utils.pad(this.date.getMonth()+1)+"/"+Utils.pad(this.date.getDate())+
...
0>b&&(b=this.UnknownIndex);a=this.ranges.length-1;for(var c=1;c<=a;c++)if(this.ranges[c]>b){c--;break}c>this.UnknownIndex&&(c=this.UnknownIndex);return c};return{init:function(){k("UnstackedAppinit");window.addEventListener("resize",yb,!1);window.addEventListener("orientationchange",xb,!1);window.addEventListener("scroll",zb,!1);document.addEventListener("keyup",Bb,!1);x()&&(document.addEventListener("mousemove",Ab,!1),Ua=!0);if(I){var a=A();a.setSeconds(a.getSeconds()-600);ma=Utils.getSQLTimeStamp(a)}e.start_date=
e.end_date=e.playback_date=A();ob();w=new Freewall("#freewall");w.reset({selector:".card",animate:1==E,cellW:ua,cellH:"auto",gutterX:R,gutterY:R,onResize:function(){F()},bottomToTop:!1,delay:0});X&&hb(!xa);$(".tzone").text(A().getZoneAbbreviation());Sa(K);$("#status").prepend(Y.domElement);QuickSettings.useExtStyleSheet();t=QuickSettings.create(window.innerWidth-195,45,"[ Controls ]");v||t.addRange("Playback Speed",.0166,10,fa,.0166,function(a){fa=a;e.playback_seconds_step=fa});t.addBoolean("Playing",
...
a.value);switch(a.value){case u.ALL.label:C=u.ALL.value;break;case u.WITH_IMAGE.label:C=u.WITH_IMAGE.value;break;case u.WITHOUT_IMAGE.label:C=u.WITHOUT_IMAGE.value}ja()});$("a").click(function(){k("Click",$(this).attr("href"));z("external_link","click",$(this).attr("href"))});v&&(e.start_date=A(),e.start_date.setSeconds(e.start_date.getSeconds()-60*na));(0==Aa||Utils.isMobile.any())&&t.toggleVisibility();Fb?(k("showHome",za),Utils.show("#home-box"),za&&($a=setTimeout(f,12E3)),$("#details-labels > p:lt(3)").html("&nbsp;"),
